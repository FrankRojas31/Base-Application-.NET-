...
{
    public class UnidadesMateriasServices : ServiceBase<UnidadesMaterias, UnidadesMateriasDTO>, IUnidadesMateriasServices
    {
        private readonly IUnidadesMateriasRepository _repository;
        public UnidadesMateriasServices(IMapper mapper, IUnidadesMateriasRepository repository) : base(mapper, repository)
        {
